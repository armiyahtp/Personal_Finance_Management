...
const Home = () => {
  ...
  useEffect(() => {
    if (!cUser) return; // Prevents fetching if user is null
  ...
  const handleSubmit = async (e) => {
    ...
    if (data.success === true) {
      console.log("User ID in frontend:", cUser?._id);
            ...
            <div className="container-fluid">
              ...
              <div className="row mt-5">
                <div className="col-md-11 d-flex justify-content-between align-items-center">
                  <div>
                    <Button onClick={handleShow} variant="success" className="addNew me-2 mb-5">
                      Add New
                    </Button>
                    <Button onClick={handleShow} variant="success" className="mobileBtn mb-3">
                      +
                    </Button>
                  </div>
                </div>
